...
in {
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      # windowrule (v0.53+ syntax)
      windowrule = [
        "match:class ^(rofi)$, pin 1"
        "match:class ^(org.pulseaudio.pavucontrol)$, float 1"
        "match:class ^(org.pulseaudio.pavucontrol)$, size 900 450"
        "match:class ^(com.github.wwmm.easyeffects)$, float 1"
        "match:class ^(com.github.wwmm.easyeffects)$, size 900 450"
        "match:class ^(com.github.hluk.copyq)$, float 1"
        "match:class ^(com.github.hluk.copyq)$, size 422 652"

        # "suppressevent maximize" # Removed in v0.53 - need new syntax
      ];
    };
    ...
    in ''
      ...
      exec-once = systemctl --user set-environment NIX_XDG_DESKTOP_PORTAL_DIR=/run/current-system/sw/share/xdg-desktop-portal/portals
      exec-once = systemctl --user import-environment PATH
      exec-once = systemctl --user restart xdg-desktop-portal xdg-desktop-portal-gtk
